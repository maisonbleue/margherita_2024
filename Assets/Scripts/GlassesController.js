...
//    mySceneObject.setParent(script.getSceneObject());
    print("My Object: " + mySceneObject.name)
    print("Parent Object: " + mySceneObject.getParent().name)
    print("Parent Parent Object: " + mySceneObject.getParent().getParent().name)
